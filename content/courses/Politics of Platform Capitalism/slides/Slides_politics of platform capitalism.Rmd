...
# Session 8: The Comparative Politics of Uber


---


## Discursive Sentiment


```{r fig.align='center', fig.height=7, fig.width=14}
sentiment_score_lexicoder_boot%>%
  ...
  facet_wrap( ~ discourse, scales = "free") +
...
topic_estimates_full%>%
  ...
  geom_pointrange(aes(ymin = lower, ymax = upper), size = 1.4)+
  coord_flip()+
  scale_x_reordered()+
...
### Read the excerpts from Fredrik Söderqvist (an economist at Unionen) and identify key features of the 'Nordic Approach to Platform Regulation'. 
...
# Session 9: The normative politics of data governance
...
knitr::include_graphics("EUlawrequestsI.png")
```
---
####SIRIUS EU Digital Evidence Situation Report 2019
<br>
...
##What are the implications of public-private security cooperation in digital capitalism? 
...
####Why is the transatlantic relationship so difficult when it comes to data governance? Imagine you are tasked with the negotiation of a new deal – what challenges and stakeholders do you have to consider and what would you propose as potential solutions…
...
---
## The role of oversight and secrecy 

.pull-left[

```{r out.width= '80%'}
knitr::include_graphics("Potarlington.jpeg")
```
]

.pull-right[
```{r out.width= '70%'}
knitr::include_graphics("DPCHQ.png")
```
]
...
# Session 10: Explaining the GDPR
...
# Session 11:  Data Protection Beyond Europe

---
# Regional internets 

```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("splinternet3.png"
)
```

```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("splinternet2.png"
)
```

```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("splinternet1.png"
)
```
---
...
####-	Will we have multiple regional or national internets? 

####-	What criteria can we apply to measure this? 

####-	Does this represent a utopian or dystopian scenario? 

####Discuss in groups. Groups 1 and 2: Utopia, Groups 3 and 4: Dystopia.
...
# Session 12:  Polanyi and the Platform Economy
...
### Can we think of data as a fictitious commodidity, i.e., as if it was something that is created for the market while it is not? And if so, what are the dangers of treating it as a commodifity?
...
# Session 13: Not just Breaking but also Making the Law

---


## The Limits of Anti-Trust? Bork vs Khan
...
```{r out.width= '80%' , fig.align='center'}
knitr::include_graphics("https://static.independent.co.uk/s3fs-public/thumbnails/image/2012/12/25/20/Robert-Bork-reuters.jpg?width=990&auto=webp&quality=75
")
```
...
```{r out.width= '80%' , fig.align='center'}
knitr::include_graphics("https://image.cnbcfm.com/api/v1/image/106871680-16190182982021-04-21t151546z_2016679555_rc2f0n9fc9u0_rtrmadp_0_usa-biden-nasa.jpeg?v=1619018364
")
```
...
And predatory pricing? It is “a phenomenon that probably does not exist,” he wrote. The Chicago school, he said, had proved that companies would always pursue short-term profits over long-term growth.
...
# Session 14:  Knowledge and digital capitalism
...
.pull-left[
###What can we learn from Strangean knowledge structures about digital capitalism? <br>What is missing? 
]

.pull-right[
```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/d/d6/Professor_Susan_Strange%2C_c1980.jpg
")
```
]
...
####How can fiction help us understand structures <br> of knowledge and/or social imaginaries? <br> How can this help us understand digital capitalism? 

####Group 1 and 2 – Focus on structures of knowledge  

####Group 3 and 4 – Focus on sociotechnical imaginaries 

https://www.youtube.com/watch?v=kaawwz2ozcw
