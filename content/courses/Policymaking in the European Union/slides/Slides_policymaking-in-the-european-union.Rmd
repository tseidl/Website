...
[Session 10: Environmental Policy](#part10)

[Session 11: Foreign Policy](#part11)
...
- Contrary to common wisdom, business do not always get what it wants in European politics (e.g. Dür et al. 2019, Klüver 2013)

- Two questions: 

  - Why are business interests not more successful in EU policymaking?
  - What are the conditions under which they are successful?
  
  
- Two partial answers: 

  - Businesses are not always successful because the EU increasingly regulates markets beyond the regulation required to establish these markets in the first place (Dür et al. 2019, p. 6)
  - Businesses are more successful under conditions of low salience, unity, and when dealing with the right DGs or committees (Rasmussen 2015); under high salience, the benefits of diverse coalitions outweigh the cooperation costs of building such coalitions (Junk 2019)
...
## Example: The Snowden Salience Shock
...
knitr::include_graphics("https://i.ytimg.com/vi/Fmh4RdIwswE/maxresdefault.jpg")
```
]
...
> "Astroturfing is the attempt to create an impression of widespread grassroots support for a policy, individual, or product, where little such support exists." <br> &mdash; Adam Bienkov
...
### Imagine your work as a lobbyist for Google.


#### Group 1 & Group 2: Your job ist to make sure all things Google don't get too much public attention - which strategies would you use to keep the politics of digital policymaking quiet?

#### Group 3 & Group 4: Group 1 & 2 have failed. The public spotlight is on you: What would you do to still win the political battle?
...
### Use https://lobbyfacts.eu/

#### Which three companies spend most on lobbying/have the most lobbyists right now? 

#### How does that compare to the biggest spenders in 2012?

#### Are the companies that spend the most money today also the companies that get the most meetings with EU officials?

#### Browse the data and identify one thing that you find interesting/surprising/shocking?
...
# Session 7: Agenda-Setting in the European Union
...
```{r out.width='31%', fig.align='center'}
knitr::include_graphics("img/student_papers.jpg")
```
...
## Types of Agenda-Setting Power <br> (based on Deters & Falkner 2021)
...
```{r}
data.frame (
  first_column = c("Procedural agenda-setting power",
                   "Gatekeeping power",
                   "Agenda leadership",
                   "Discursive agenda-setting power"),
  second_column = c("Formal ability (through decision rules) to make it easier to adopt the agenda-setter's preferred policy than to amend it",
                   "Formal prerogative of a structural first mover to uphold the status quo by excluding alternatives from even being discussed and setting the limits of feasible policy options",
                   "Ability to 'rally consensus' for a proposal when decision-makers are largely indifferent about competing solutions (when there are multiple negotiations equilibria) ",
                   "Ability to influence how an issue is perceived by potential decision-makers and stakeholders and thus manipulate - through cognitive or normative framing - the scope and nature of a conflict"),
  third_column = c("First Face of Power",
                   "Second Face of Power",
                   "Influence through appeal to enlightened self-interest",
                   "Third Face of Power"),
  fourth_column = c("Commission, CJEU",
                   "CJEU, Commission",
                   "European Council, Commission",
                   "European Parliament, European Council, Interest Groups")
)%>%
  rename("Type of Power" = first_column,
         "Description" = second_column,
         "Face of Power Equivalent" = third_column,
         "Main Examples" = fourth_column)%>%
  kable(booktabs = TRUE, linesep = "\\addlinespace") %>%
...
## Multiple Streams (Kingdon 2014)




```{r out.width="60%"}
knitr::include_graphics("img/Kindgon 2014.jpg")
```
...
### Look at the document on the EU's Industrial Strategy and compare the excerpts from the two documents


---

## Text Re-Use Approaches I
...
Substring matching (e.g. via the Smith–Waterman local alignment algorithm or the Damerau-Levenshtein minimum edit distance) can be employed to detect instances of coordination among interest groups since it allows us to identify similar passages of text between two documents that are not perfectly overlapping (Scott et al. 2020, RIPE; Pagliari & Young 2020, JEPP; Rauh 2020, EUP)
...
```{r out.width="90%"}
knitr::include_graphics("img/text-reuse.png")
```
...
The Commission's legislative agenda-setting power allows it "to select and to propose the one policy from the set of all feasible ones that comes closest to its own preferences. (...) I argue that the Commission’s legislative influence hinges strongly on the quality of anticipation it can muster. (...) Correctly anticipating the political leeway it enjoys for a given initiative is a necessary condition for the Commission’s legislative success. Yet, carving out this leeway is a resource-intensive business [and the individual DGs] are not created equal in this regard. " &mdash; Rauh 2020, EUP
...
```{r out.width="110%"}
knitr::include_graphics("img/rauh.png")
```
...
# Session 8: Decision-Making in the European Union
...
knitr::include_graphics("img/eu_creature.jpg")
```

---


## The Origins of EU Legislation I

<iframe src="https://embed.polleverywhere.com/multiple_choice_polls/j8XXFKLmTDazMeRosudnX?controls=none&short_poll=true" width="900px" height="500px"></iframe>

---


## The Origins of EU Legislation II
...
knitr::include_graphics("img/laloux1.png")
```
...
```{r out.width='95%', fig.align='center'}
knitr::include_graphics("img/laloux2.png")
```
...
<font size="2"> Laloux, T. and Delreux, T. (2020) ‘The origins of EU legislation: agenda-setting, intra-institutional decision-making or interinstitutional negotiations?’ *West European Politics*, pp. 1–22.
...
2020 Budget of the Irish DPA

How long it takes facebook to make that much money (ca. $200000 in revenue per minute)
...
## Suppose they make a GDPR <br> and no one comes to enforce it

.pull-left[


```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/7/71/Max_Schrems_2016_b.jpg
")
```
...
> “You can have the best law, but if nobody enforces it, then you’re not going to go anywhere.” <br>	&mdash; Max Schrems
...
- Forbearance - the active choice to not enforce certain rules - is a key but often overlooked political tool:

  - Forbearance as a means of redistribution (Holland 2017)
  - Forbearance as a form of industrial policy (Dewey & Di Carlo 2021)
  
<br>

> "Regulatory forbearance, therefore, can be thought of as functionally equivalent to direct subsidies used as old instruments of industrial policy in an age where the EU competition policy and state aid regulations significantly constrain governments’ discretionary interventions in markets." (Dewey & Di Carlo 2021)
...
###  Watch the Politico Explainer here: https://www.politico.com/story/2019/04/24/ireland-data-privacy-1270123

#### What are the 'larger economic interests of the Irish state'?

#### How can the Irish state influence the actions of the Irish Data Protection Commission?

#### What can be done to stop Ireland from undermining the GDPR?


???

"If a train never gets moving, less locomotives don't cause further delays," said Max Schrems
...
# Session 10: Environmental Policy
...
```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("https://images.unsplash.com/photo-1509391366360-2e959784a276?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80
")
```


```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("https://i.pinimg.com/564x/81/1e/2b/811e2bda45155c63a132efb8c2cc3cda--memory-foam-mattress-topper-the-.jpg
")
```


```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("https://i.rtings.com/assets/products/0C5XharC/black-decker-dustbuster-chv1410l/design-medium.jpg
")
```
...
knitr::include_graphics("https://cdn.vox-cdn.com/thumbor/ejFVoG7byOqWqMuqcksfe2UbIX0=/0x0:3000x2000/920x613/filters:focal(1260x760:1740x1240):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/66181121/CPT74F.7.jpg
")
```


```{r out.width= '50%' , fig.align='left'}
knitr::include_graphics("https://www.tuv.com/content-media-files/master-content/services/products/1535-tuv-rheinland-smoke-detector-testing-and-certification/tuv-rheiland-smoke-detector-testing-certification_core_2_2_1.jpg
")
```


```{r out.width= '50%' , fig.align='left'}
knitr::include_graphics("https://www.runningxpert.com/media/catalog/product/cache/1/image/575x/040ec09b1e35df139433887a97daa66f/e/m/emergency_blanket-.jpg
")
```
...
Other examples: fire-proof clothing, small digital cameras, wireless headphones, precision gps, etc.
...
> What is required [to combat climate change] is a mission-oriented approach which sets a clear direction for change, while at the same time using the full range of government instruments (from procurement to guaranteed loans, grants and prize schemes) to crowd in bottom-up investments and innovation across the entire economy. The change must occur at all levels — local, regional, national and international. It must be guided not by fear, but by a positive vision for change.
...
```{r out.width= '50%' , fig.align='center'}
knitr::include_graphics("https://images-na.ssl-images-amazon.com/images/I/41f+Txg2QYS._SY344_BO1,204,203,200_.jpg
")
```
...
Missions require a new vocabulary. Rather than levelling the playing field they require tilting it. This does not mean tilting it towards one company, one sector or one technology, but tilting it towards a direction. This requires ambitious investments that crowd-in and mobilise private investment as well as the creation of synergies across the different domains of government activity: from regulatory changes, to procurement policy, to reforms in education and labour markets.
...
####  Each group takes a look at  one of the four environmental missions of the EU and identifies their key goals. Also discuss what makes it a mission, what potential downstream innovations could be, and what the general pros and cons of a mission-oriented approach are.

##### Group 1 looks at Adaptation to climate change including societal transformation (https://ec.europa.eu/info/research-and-innovation/funding/funding-opportunities/funding-programmes-and-open-calls/horizon-europe/missions-horizon-europe/adaptation-climate-change-including-societal-transformation_en)

##### Group 2 looks at Healthy oceans, seas, coastal and inland waters (https://ec.europa.eu/info/research-and-innovation/funding/funding-opportunities/funding-programmes-and-open-calls/horizon-europe/missions-horizon-europe/healthy-oceans-seas-coastal-and-inland-waters_en)


##### Group 3 looks at Soil health and food (https://ec.europa.eu/info/research-and-innovation/funding/funding-opportunities/funding-programmes-and-open-calls/horizon-europe/missions-horizon-europe/soil-health-and-food_en)


##### Group 4 looks at Climate-neutral and smart cities (https://ec.europa.eu/info/research-and-innovation/funding/funding-opportunities/funding-programmes-and-open-calls/horizon-europe/missions-horizon-europe/climate-neutral-and-smart-cities_en)
...
- In recent years, we have seen a remarkable shift in several areas of EU policymaking that puts notions of geo-politics and geo-economics center stage.

- The central concept/idea tying these changes together is the idea of strategic autonomy, which comes in various guises:

  - In digital policy there is much talk about digital/technological sovereignty.
  - In trade policy the EU has proposed a new strategy based on the concept of *open* strategic autonomy.
  - In foreign policy, strategic autonomy increasingly is *the* central concept.
  
  
- However, there remains much confusion and disagreement as to what strategic autonomy is and should be.
...
knitr::include_graphics("https://ecfr.eu/wp-content/uploads/Q3-How-important-is-the-goal-of-European-strategic-autonomy.png
")
```
...
> Strategic autonomy as the "ability to decide and to act freely in an interdependent world" <br> &mdash; République française (2017): Revue stratégique de défense et de sécurité nationale


<br>

> "This study defines EU's 'strategic autonomy' as the ability to act autonomously as well as to choose when, in which area, and if, to act with like-minded partners. The capacity to act autonomously implies both the ability to decide and to implement decisions in an autonomous manner. 'Strategic autonomy' is not about self-sufficiency but about means and tools to reduce external dependencies in areas deemed strategic and where dependencies could compromise autonomy, whilst continuing to cooperate with partners in a multilateral setting." <br> &mdash; EPRS (2020): On the path to 'strategic autonomy'
...
#### Take a look at section 4.4 ('Security and defence') of the EPRS report "On the path to 'strategic autonomy'".


##### Group 1 looks at subsection 4.4.1

##### Group 2 looks at subsection 4.4.2

##### Group 3 looks at subsection 4.4.3

##### Group 4 looks at subsection 4.4.4


#### Identify what strategic autonomy means and how the report argues it could be realized. You can already take a critical stance, asking whether or not strategic autonomy is a useful concept, however defined.
...
knitr::include_graphics("img/bankenverband.PNG")
